...
# From: https://github.com/espressif/esp-idf/blob/master/components/spiffs/spiffsgen.py
# Docs: https://github.com/espressif/esp-idf/blob/master/docs/en/api-reference/storage/spiffs.rst
#
